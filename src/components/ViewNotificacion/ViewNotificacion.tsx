...
const ViewNotificacion = (props: IViewNotification) => {
    ...
    const chooseView = (number: number) => {
        var view = <></>;
        if (number === 0) {
            view = <section className="ViewNotificaciones">
                ...
                <article className="ViewNotificaciones__header">
                    ...
                    <div className="ViewNotificaciones__header__icon" onClick={()=>{setPage(1)}}>
...
const SendNotification = () => {
    ...
    const [notification] = useState(new ONotification());
    ...
    const enviar = () => {
        ...
        notification.setTo_Type(NameUser.Adviser);

        notification.addToDatabase(() => {
            setPageG(CasesManager.NOTIFICATIONS);
        });
    }
    ...
    return (
        <section className="ViewNotificaciones">
            ...
            <article className="ViewNotificaciones__header">
                <div className="ViewNotificaciones__header__title">
                    ...
                    <div className="ViewNotificaciones__header__content">
                        <p>Asunto: </p> <input onChange={(e) => { setSuject(e.target.value) }} type="text" />
                    </div>
                </div>
            </article>
            ...
            <article className="ViewNotificaciones__inputFile">
                <button onClick={enviar} className="ViewNotificaciones__inputFile__enviar"> Enviar </button>
            </article>
        </section>
    )
}